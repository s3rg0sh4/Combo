...
namespace Combo.Migrations
{
    ...
    [Migration("20240509112326_RouteSheets")]
    partial class RouteSheets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Combo.Database.Models.Route", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset>("UnloadEnd")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset>("UnloadStart")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Combo.Database.Models.RouteSheet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<DateTimeOffset>("ArrivalDatePlanned")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("ArrivalDateReal")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTimeOffset>("UploadDatePlanned")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("UploadDateReal")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Combo.Database.Models.Route", b =>
                {
                    b.HasOne("Combo.Database.Models.RouteSheet", "RouteSheet")
                        .WithMany("Routes")
            ...
            modelBuilder.Entity("Combo.Database.Models.RouteSheet", b =>
                {
                    b.HasOne("Combo.Database.Models.Driver", "Driver")
                        .WithMany()
                        .HasForeignKey("DriverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Combo.Database.Models.Trailer", "Trailer")
                        .WithMany()
                        .HasForeignKey("TrailerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Combo.Database.Models.Truck", "Truck")
                        .WithMany()
            ...
            modelBuilder.Entity("Combo.Database.Models.Waybill", b =>
                {
                    ...
                    b.HasOne("Combo.Database.Models.Route", null)
                        .WithMany("Waybills")
                        .HasForeignKey("RouteId");

                    b.HasOne("Combo.Database.Models.RouteSheet", null)
                        .WithMany("Waybills")
                        .HasForeignKey("RouteSheetId");
